...
const Rows = ({ date, fromToken, toToken, fromAddress, toAddress, chainType, status }) => {
  ...
  return (
    <Grid container spacing={2} className={classes.rowsContainer}>
      <Grid item xs={6} md={2}>
    ...
    //     </CardActions> */}
    //   </Box>
    // <Collapse in={expanded} timeout="auto" unmountOnExit><Typography paragraph>Txn Hash</Typography>/Collapse>
    // </>
  );
};
